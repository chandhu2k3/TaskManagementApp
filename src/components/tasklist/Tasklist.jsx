...
import Completedetasklist from './Completedetasklist'
import Failed from './Failed'

const Tasklist = ({data}) => {
  return (
    <div id='tasklist' className='  h-[55%] overflow-x-auto flex items-center py-5 justify-start gap-8 flex-nowrap mt-10 w-full'>
   {data.tasks.map((elem,idx)=>{
         ...
         if(elem.completed){
           return <Completedetasklist key={idx} data={elem} />
         }
         if(elem.failed){
